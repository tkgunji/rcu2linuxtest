...
static char* g_mrLogPrefix=DEFAULT_LOG_PREFIX;
//u16 g_logflags=LOG_FLAG_ALL;
//static int g_logflags=LOG_ERROR|LOG_WARNING|LOG_INFO|LOG_OPEN_CLOSE;

//static char g_logfilename[LOG_FILE_NAME_MAX_LENGTH]="";
#ifndef NODEBUG
//int mrLogMessage(const char* origin, u16 logflag, const char *fmt, ...)
int mrlogmessage(int logflag, const char *fmt, ...)
{
  va_list args;
  int tgtLen;
